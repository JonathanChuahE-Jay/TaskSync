...
import SideBarExpander from '@/components/root/Navbar/SideBarExpander.tsx'
	...
	return (
		<motion.aside
			className={cn(
				...
				isExpanded ? 'w-64 duration-300' : 'w-16 duration-300',
			)}
			initial={false}
		>
			<div className="relative h-full">
				<SideBarExpander handleSideBarExpand={handleSideBarExpand} />
