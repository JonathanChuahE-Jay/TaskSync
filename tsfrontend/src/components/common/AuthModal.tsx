...
const AuthModal = ({ children }: { children: ReactNode }) => {
	return (
		<motion.div
			...
			className="relative z-10 scrollbar-hide bg-white/40 dark:bg-black/40 rounded-2xl shadow-2xl backdrop-blur-xl border border-white/50 w-[600px] max-w-[90%] max-h-[90dvh] overflow-y-auto overflow-x-hidden p-8 transition duration-700 ease-in-out"
		>
